...
Yes the final value is correct.
...
It is clear that the threads are running concurrently because when most of them print the value of the counter
the value is 0. But at the end the value is correct.
...
All of the values are above 0. So yes thousands of errors.
